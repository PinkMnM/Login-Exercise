...
class User(db.Model):
    ...
    first_name = db.Column(db.String(NAME_LENGTH), nullable=False)

    last_name = db.Column(db.String(NAME_LENGTH), nullable=False)
    ...
    feedback_to_others = db.relationship(
        "Feedback",
...
class Feedback(db.Model):
    ...
    from_username = db.Column(
        db.String(User.USERNAME_LENGTH), db.ForeignKey(User.username), nullable=False
    )
